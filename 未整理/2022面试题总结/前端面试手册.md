...
domain: null
originalLink: null
createTime: 2023-05-07T17:52:34.000Z
...
1. **no-cache** 强制所有缓存了该响应的用户，在使用已缓存的数据前，发送带验证的请求到服务器, 问服务器是否可以读缓存。
...
| destroyed     | 在组件销毁后调⽤ (像定时器,  webscoket 连接, … 跟 vue 没有太大关联的资源, 需要手动释放!) |
...
1. SSR 服务器渲染
   ...
   关于服务器渲染：[Vue官网介绍](https://ssr.vuejs.org/zh/#什么是服务器端渲染-ssr-？)，对 Vue 版本有要求，对服务器也有一定要求，需要支持 nodejs 环境。
